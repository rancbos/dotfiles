...
if has('folding') && has('vim_starting')
	set foldenable
	set foldmethod=indent  " 代码折叠，使用zc按键来创建折叠，使用za来打开或者关闭折叠
...
filetype indent on  "允许 vim 为不同类型的文件定义不同的缩进格式，并且载入与该类型对应的缩进规则
filetype plugin on  "允许 vim 加载文件类型插件
"filetype plugin indent on  "等于上面三条命令
...
" Snippets
source $HOME/dotfiles/nvim/md-snippets.vim
" auto spell
